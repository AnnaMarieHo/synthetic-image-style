...
def generate_explanation(model, tokenizer, item):
    ...
    validated_pairs = []
    #  CRITICAL: Enforce top 2 pairs limit exactly as in the explanation script 
    ...
    # VRAM Management (for preventing CUDA errors on my poor ML "rig")
    del outputs 
    del inputs
...
def main():
    ...
    for sample_id, item in tqdm(test_subset.items(), desc="Generation"):
        ...
        # Truncate to the first two sentences for functional accuracy review
